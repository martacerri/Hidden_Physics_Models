...
function [error, error_noise, lambda1, lambda2, lambda1_noise, lambda2_noise] = Schrodinger(N0,N1,i,label,filename)
...
error = max(error_u, error_v);              % my (arbitrary) choice...
